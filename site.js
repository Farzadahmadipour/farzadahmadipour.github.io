  ...
  (function(){
    const slides = document.querySelectorAll('#blogCarousel .blog-slide');
    const dots = document.querySelectorAll('#blogCarousel .blog-dots .dot');
    ...
    window.goToBlogSlide = function(i){
      showSlide(i);
      restartTimer();
    };
